...
import { Search, MapPin, GraduationCap, Sparkles, ArrowRight, Bookmark, Filter, ChevronDown, X, FlaskConical, Globe, Briefcase, Palette, Heart, BookOpen, Laptop, Building2, Clock, DollarSign, Users } from "lucide-react";
...
const programsData: Program[] = [
  ...
  {
    id: "p3", title: "B.Sc. in Economics & Data Science", university: "Stanford University", location: "Stanford, USA", country: "USA",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Stanford_University_seal.svg/1024px-Stanford_University_seal.svg.png",
    image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=800",
    degreeLevel: "Bachelor's", category: "university", fields: ["business", "stem"], studyMode: "On-Campus", duration: "4 Years", tuition: 56169,
    targetLevel: ["undergraduate"], tags: ["Economics", "Data Analysis", "Policy"],
    description: "Interdisciplinary program focusing on the intersection of markets and technology.",
    special_features: ["Data Science Lab", "Policy Research Center", "Tech Internships"],
    noticable_facts: ["Top 3 Economics Dept", "Access to Silicon Valley"], featured: false
  },
  {
  ...
  {
    id: "p13", title: "MIT PRIMES — Research in Mathematics", university: "MIT", location: "Cambridge, USA", country: "USA",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/MIT_logo.svg/1024px-MIT_logo.svg.png",
    ...
    description: "Free year-long research for mathematically talented high schoolers working with MIT faculty.",
  ...
  {
    id: "p14", title: "Carnegie Mellon SAMS", university: "CMU", location: "Pittsburgh, USA", country: "USA",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Carnegie_Mellon_University_seal.svg/1024px-Carnegie_Mellon_University_seal.svg.png",
    image: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=800",
    degreeLevel: "Summer", category: "summer", fields: ["stem"], studyMode: "On-Campus", duration: "5 Weeks", tuition: 0,
    targetLevel: ["high_school"], tags: ["STEM", "Free", "Underrepresented", "Engineering"],
    description: "Summer Academy for Math and Science — full scholarship for underrepresented students.",
    special_features: ["Full Scholarship", "CMU Faculty", "Hands-on Projects"],
    noticable_facts: ["Covers travel, food, and housing", "Prepares students for elite STEM colleges"], apply_link: "https://www.cmu.edu/pre-college/academic-programs/sams.html"
  },
  {
    id: "p15", title: "Telluride Association Summer Seminar", university: "Telluride Association", location: "Cornell / Michigan / Maryland", country: "USA",
    logo: "https://cdn-icons-png.flaticon.com/512/3135/3135810.png",
    image: "https://images.unsplash.com/photo-1494412651409-8963ce7935a7?q=80&w=800",
    degreeLevel: "Summer", category: "summer", fields: ["humanities"], studyMode: "On-Campus", duration: "6 Weeks", tuition: 0,
    targetLevel: ["high_school"], tags: ["Humanities", "Social Sciences", "Free", "Critical Theory"],
    description: "Intensive seminars in critical Black studies and anti-oppressive studies.",
    special_features: ["Entirely Free", "Democratic Governance", "High Level Academics"],
    noticable_facts: ["Most prestigious humanities summer program", "Covers all costs including travel"], apply_link: "https://www.telluride-association.org/"
  },
  {
    id: "p16", title: "Franklin Research Internship Program", university: "Franklin Research", location: "Global / Remote", country: "Global",
    logo: "https://cdn-icons-png.flaticon.com/512/3135/3135810.png",
    image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=800",
    degreeLevel: "Internship", category: "research", fields: ["stem", "humanities", "business", "arts"], studyMode: "Online", duration: "Flex", tuition: 1500,
    targetLevel: ["high_school", "undergraduate"], tags: ["Research", "Mentorship", "Interdisciplinary"],
    description: "Personalized mentor-matching for independent research projects across any discipline.",
    special_features: ["Personalized Matching", "Any Discipline", "Flexible Timeline"],
    noticable_facts: ["Most flexible research option", "Mentors from top universities"], apply_link: "https://franklinresearch.org/"
  },
  {
    id: "p21", title: "NASA OSTEM Internships", university: "NASA", location: "Various Centers", country: "USA",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/NASA_logo.svg/1024px-NASA_logo.svg.png",
    image: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?q=80&w=800",
    degreeLevel: "Internship", category: "internship", fields: ["stem"], studyMode: "On-Campus", duration: "10-16 Weeks", tuition: 0,
    targetLevel: ["high_school", "undergraduate", "graduate"], tags: ["NASA", "Paid", "Engineering", "Space"],
    description: "Work on real NASA projects alongside scientists and engineers.",
    special_features: ["Paid Internship", "Real NASA Projects", "Networking"],
    noticable_facts: ["High conversion to full-time roles", "Stipends provided"], apply_link: "https://intern.nasa.gov/"
  },
  {
    id: "p22", title: "NSF REU — Research Experience for Undergraduates", university: "National Science Foundation", location: "USA (600+ Sites)", country: "USA",
    logo: "https://cdn-icons-png.flaticon.com/512/3135/3135810.png",
    image: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=800",
    degreeLevel: "Summer", category: "research", fields: ["stem"], studyMode: "On-Campus", duration: "10 Weeks", tuition: 0,
    targetLevel: ["undergraduate"], tags: ["Research", "Paid", "STEM", "Funded"],
    description: "600+ fully funded summer research placements across the USA.",
    special_features: ["Stipend Provided", "Housing Included", "600+ Sites"],
    noticable_facts: ["Fully funded", "Best research credential for grad school"], apply_link: "https://www.nsf.gov/crssprgm/reu/"
  }
];

const CATEGORIES = [
  { v: "university", l: "University Degree", icon: <GraduationCap size={16} /> },
  { v: "summer", l: "Summer Program", icon: <Sparkles size={16} /> },
  { v: "research", l: "Research", icon: <FlaskConical size={16} /> },
  { v: "internship", l: "Internship", icon: <Briefcase size={16} /> },
  { v: "online", l: "Online/Certificate", icon: <Laptop size={16} /> }
];

const FIELDS = [
  { v: "stem", l: "STEM", icon: <FlaskConical size={16} /> },
  { v: "medicine", l: "Medicine", icon: <Heart size={16} /> },
  { v: "business", l: "Business", icon: <Briefcase size={16} /> },
  { v: "humanities", l: "Humanities", icon: <BookOpen size={16} /> },
  { v: "arts", l: "Arts & Design", icon: <Palette size={16} /> },
  { v: "environment", l: "Environment", icon: <Globe size={16} /> }
];
          ...
          <div className={\`container \${styles.layout}\`}>
            ...
            <aside className={styles.filterSidebar} style={{ display: showMobileFilters ? "block" : undefined }}>
              ...
              <div className={styles.filterSection}>
                <div className={styles.filterSectionHeader} onClick={() => togSection("category")}>
                  <span className={styles.filterSectionTitle}>Category</span>
                  <ChevronDown size={14} className={\`\${styles.filterChevron} \${openSections.includes("category") ? styles.open : ""}\`} />
                </div>
                {openSections.includes("category") && (
                  <div className={styles.checkGrid}>
                    {CATEGORIES.map(o => (
                      <label key={o.v} className={styles.checkLabel}>
                        <input type="checkbox" checked={categories.includes(o.v)} onChange={() => tog(categories, o.v, setCategories)} />
                        <span style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>{o.icon} {o.l}</span>
                      </label>
                    ))}
                  </div>
                )}
              ...
              <div className={styles.filterSection}>
                <div className={styles.filterSectionHeader} onClick={() => togSection("field")}>
                  <span className={styles.filterSectionTitle}>Field of Study</span>
                  <ChevronDown size={14} className={\`\${styles.filterChevron} \${openSections.includes("field") ? styles.open : ""}\`} />
                </div>
                {openSections.includes("field") && (
                  <div className={styles.checkGrid}>
                    {FIELDS.map(o => (
                      <label key={o.v} className={styles.checkLabel}>
                        <input type="checkbox" checked={fields.includes(o.v)} onChange={() => tog(fields, o.v, setFields)} />
                        <span style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>{o.icon} {o.l}</span>
                      </label>
                    ))}
                  </div>
              ...
              <div className={styles.filterSection}>
                <div className={styles.filterSectionHeader} onClick={() => togSection("level")}>
                  <span className={styles.filterSectionTitle}>Target Level</span>
                  <ChevronDown size={14} className={\`\${styles.filterChevron} \${openSections.includes("level") ? styles.open : ""}\`} />
                </div>
                {openSections.includes("level") && (
                  <div className={styles.checkGrid}>
                    {LEVELS.map(o => (
                      <label key={o.v} className={styles.checkLabel}>
                        <input type="checkbox" checked={levels.includes(o.v)} onChange={() => tog(levels, o.v, setLevels)} />
                        {o.l}
                      </label>
                    ))}
                  </div>
              ...
              <div className={styles.filterSection}>
                <div className={styles.filterSectionHeader} onClick={() => togSection("mode")}>
                  <span className={styles.filterSectionTitle}>Study Mode</span>
                  <ChevronDown size={14} className={\`\${styles.filterChevron} \${openSections.includes("mode") ? styles.open : ""}\`} />
                </div>
                {openSections.includes("mode") && (
                  <div className={styles.checkGrid}>
                    {MODES.map(o => (
                      <label key={o} className={styles.checkLabel}>
                        <input type="checkbox" checked={modes.includes(o)} onChange={() => tog(modes, o, setModes)} />
                        {o}
                      </label>
                    ))}
                  </div>
...
fs.writeFileSync(path.join(process.cwd(), 'src/app/(public)/programs/page.tsx'), programsContent, 'utf8');
console.log('Programs page restored with rich content and proper encoding.');
