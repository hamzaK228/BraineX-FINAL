    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", background: "var(--bg-color)" }}>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <h1 style={{ fontSize: "1.75rem", fontWeight: "700", margin: "0 0 0.5rem 0", color: "var(--text-color)" }}>Welcome back</h1>
          <p style={{ color: "var(--text-muted)", margin: 0, fontSize: "0.95rem" }}>Enter your credentials to access your dashboard</p>
        </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Link href="/login?forgot=true" style={{ fontSize: "0.8rem", color: "#3b82f6", textDecoration: "none", fontWeight: "500" }}>Forgot password?</Link>
              </div>
              <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
