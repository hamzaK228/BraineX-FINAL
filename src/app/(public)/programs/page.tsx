...
const programsData: Program[] = [
  {
    id: "p1", title: "MIT PRIMES (Research in Math)", university: "Massachusetts Institute of Technology", location: "Cambridge, USA", country: "USA",
    level: "High School", category: "Research", fields: ["STEM", "Mathematics"], format: "Hybrid", duration: "12 Months", tuition: 0,
    tags: ["Mathematics", "Research", "Competition"], eligibility: ["International", "Domestic"],
    description: "MIT PRIMES is a free, year-long research program for high school students who are mathematically talented.",
    featured: true, apply_link: "https://math.mit.edu/research/highschool/primes/"
  },
  {
    id: "p2", title: "Stanford Summer Humanities Institute", university: "Stanford University", location: "Stanford, USA", country: "USA",
    level: "High School", category: "Summer", fields: ["Humanities"], format: "Offline", duration: "3 Weeks", tuition: 0,
    tags: ["Humanities", "Philosophy", "Writing"], eligibility: ["International", "Domestic"],
    description: "Explore the big questions at the heart of the humanities with Stanford faculty.",
    featured: true, apply_link: "https://summerhumanities.stanford.edu/"
  },
  {
    id: "p3", title: "RSI (Research Science Institute)", university: "MIT & CEE", location: "Cambridge, USA", country: "USA",
    level: "High School", category: "Research", fields: ["STEM"], format: "Offline", duration: "6 Weeks", tuition: 0,
    tags: ["STEM Research", "Competition", "Cost-Free"], eligibility: ["International", "Domestic"],
    featured: true, apply_link: "https://www.cee.org/research-science-institute"
  },
  {
    id: "p4", title: "KAUST Discovery Scholars Program", university: "KAUST", location: "Thuwal, Saudi Arabia", country: "Saudi Arabia",
    level: "Undergraduate", category: "Research", fields: ["STEM"], format: "Offline", duration: "6 Weeks", tuition: 0,
    tags: ["STEM", "Research", "Fully Funded"], eligibility: ["International"],
    featured: false, apply_link: "https://vrp.kaust.edu.sa/"
  },
  {
    id: "p11", title: "QuestBridge College Prep Scholars", university: "QuestBridge", location: "USA", country: "USA",
    level: "High School", category: "Summer", fields: ["Interdisciplinary"], format: "Hybrid", duration: "1 Year", tuition: 0,
    tags: ["Full Scholarship", "College Prep"], eligibility: ["Domestic"],
    apply_link: "https://www.questbridge.org/"
  },
  {
    id: "p12", title: "Carnegie Mellon SAMS", university: "Carnegie Mellon University", location: "Pittsburgh, USA", country: "USA",
    level: "High School", category: "Summer", fields: ["STEM"], format: "Offline", duration: "5 Weeks", tuition: 0,
    tags: ["STEM", "Full Scholarship"], eligibility: ["Domestic"],
    apply_link: "https://www.cmu.edu/pre-college/academic-programs/sams.html"
  },
  {
    id: "p13", title: "NSF REU", university: "National Science Foundation", location: "USA", country: "USA",
    level: "Undergraduate", category: "Research", fields: ["STEM"], format: "Offline", duration: "10 Weeks", tuition: 0,
    tags: ["STEM", "Paid", "Funded"], eligibility: ["Domestic"],
    apply_link: "https://www.nsf.gov/crssprgm/reu/"
  },
  {
    id: "p14", title: "NASA OSTEM Internships", university: "NASA", location: "Multiple Sites, USA", country: "USA",
    level: "High School", category: "Internship", fields: ["STEM"], format: "Offline", duration: "10-16 Weeks", tuition: 0,
    tags: ["STEM", "NASA", "Paid"], eligibility: ["Domestic"],
    apply_link: "https://intern.nasa.gov/"
  },
  {
    id: "p15", title: "CERN Summer Student Program", university: "CERN", location: "Geneva, Switzerland", country: "Switzerland",
    level: "Undergraduate", category: "Research", fields: ["STEM"], format: "Offline", duration: "8-13 Weeks", tuition: 0,
    tags: ["Physics", "Funded"], eligibility: ["International", "Domestic"],
    apply_link: "https://home.cern/students"
  },
  {
    id: "p18", title: "Lumiere Research Scholar Program", university: "Lumiere Education", location: "Online / Global", country: "Global",
    level: "High School", category: "Research", fields: ["Interdisciplinary"], format: "Online", duration: "12 Weeks", tuition: 3950,
    tags: ["Research", "Mentorship"], eligibility: ["International", "Domestic"],
    apply_link: "https://www.lumiere.education/"
  }
];
...
export default function ProgramsPage() {
  ...
  const fieldOptions = ["STEM", "Mathematics", "Medicine", "Humanities", "Business", "Arts", "Interdisciplinary"];
